...
برای تعیین نام گروه🔽
[!/]setname [name]
برای تعیین درباره گروه از ریلم🔽
[!/]setabout [group_id] [text]
برای تعیین قوانین گروه‌ از ریلم🔽
[!/]setrules [group_id] [text]
=======================
برای قفل یکی از تنظیمات از گروه از ریلم🔽
[!/]lock [group_id] [setting]
برای باز کردن قفل یکی‌ از تنظیمات گروه از ریلم🔽
[!/]unlock [group_id] [setting]
=======================
برای مشاهده اعضای گروه در یک پیام🔽
[!/]wholist
برای مشاهده اعضای گروه در یک فایل🔽
[!/]who
=======================
برای مشاهده نوع چت🔽
[!/]type
=======================
برای پاک کردن یک گروه🔽
[!/]kill chat [group_id]
برای پاک کردن یک ریلم🔽
[!/]kill realm [Realm_id
برای اضافه کردن ادمین گلوبال🔽
[!/]addadmin [id|username]
برای حذف کردن ادمین گلوبال🔽
[!/]removeadmin [id|username]
=======================
برای مشاهده لیست گروه ها🔽
[!/]list groups 
برای مشاهده لیست ریلم ها🔽
[!/]list realms 
برای مشاهده لیست گلوبال ادمین ها🔽
[!/]list admins
======================
برای دریافت لوگ گروه🔽
[!/]log 
======================
⛔توجه⛔: تمامی دستورات با‌! و‌/ کار میکنند
=======================
Made by @amir_sereen 
]],
